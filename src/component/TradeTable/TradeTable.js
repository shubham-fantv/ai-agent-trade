...
const TradeTable = ({ agentDetail }) => {
  ...
  const AccountCell = ({ account }) => (
    <div className="flex items-center space-x-2">
      ...
      <span className="font-mono text-[#CCFF00]">{formatWalletAddress(account, 5)}</span>
    </div>
  );
        ...
        >
          <div className="flex items-center">
            ...
            >
              ...
              <span className="font-mono text-[#CCFF00]">{formatWalletAddress(tx.sender, 5)}</span>
            </div>
          </div>
          <span
            className={`px-2 py-1 rounded text-sm ${
              tx.transactionType === "BUY" ? "text-green-100" : "text-red-400"
            }`}
          >
            {tx.transactionType}
          </span>
        ...
        <table className="w-full">
          <thead>
            <tr className="w-full text-gray-400 border-b border-gray-800">
              <th className="py-4 font-normal  text-left font-nohemi text-[14px] leading-[21px]">
                ACCOUNT
              </th>
              <th className="py-4 font-normal  text-center font-nohemi text-[14px] leading-[21px]">
                TYPE
              </th>
              <th className="py-4 font-normal  text-center font-nohemi text-[14px] leading-[21px]">
                $MAN
              ...
              <th className="py-4 font-normal  text-center font-nohemi text-[14px] leading-[21px]"></th>
              <th className="py-4 font-normal  text-center font-nohemi text-[14px] leading-[21px]">
                TRANSACTION
              </th>
            </tr>
