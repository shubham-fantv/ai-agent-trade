...
export default function Home() {
  ...
  console.log("🚀 ~ Home ~ activeTab:", activeTab);
            ...
            <div className="flex flex-col items-center justify-between gap-4 mb-8 sm:flex-row">
              ...
              <div className="flex items-center flex-shrink-0 gap-2">
                ...
                <label className="inline-flex items-center gap-2">
                  ...
                  <span className="text-sm">Graduated Agents</span>
                </label>
              </div>
            </div>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="text-[14px] font-normal flex items-center">
                              ...
                              <span
                                style={{ fontSize: "12px" }}
                                className="text-[12px text-[#D2D2D2] px-1.5 rounded bg-black/20 "
                              >
                                ({agent?.ticker})
                              </span>
                              <svg
...
text-[#D2D2D2] font-nohemi text-[14px] font-normal leading-[21px]`}
                      ...
                      <div className="text-center text-[#D2D2D2] font-nohemi text-[14px] font-normal leading-[21px]">
                        {agent.tvl}
                      </div>
                      <div className="text-center text-[#D2D2D2] font-nohemi text-[14px] font-normal leading-[21px]">
                        {agent.holders}
