        ...
        <div className="relative rounded-2xl overflow-hidden bg-gradient-to-b p-6 pb-8 from-[#CCFF00]/50 to-[#1E1E1E]">
          ...
          <div className="relative z-10">
            <div className="mb-8 flex flex-col sm:flex-row justify-between items-center gap-4">
              {/* Filter Tabs */}
              <div className="rounded-full p-2 flex gap-1 bg-white/20 backdrop-blur-sm overflow-x-auto">
                <button
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="h-[48px] w-[48px] rounded-[8px] bg-blue-500 flex items-center justify-center p-4">
                        <img src={agent?.agent} className="h-[48px] w-[48px]" />
                      </div>
                      <div>
                        ...
                        <div className="w-[128px] mt-1 px-2 text-[10px] text-[#CCFF00] bg-[#353B1A] flex justify-between items-center gap-1 border-[2px] border-[#CCFF00]/30 rounded-[8px]">
                    ...
                    <div className="text-right">{agent.volume24}</div>
